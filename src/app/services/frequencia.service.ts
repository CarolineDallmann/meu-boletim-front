...
export class FrequenciaService {
  ...
  getBuscarFrequencia(turmaId: string, materiaId: string, data: string) {
    return this.http.get<FrequenciaResponse[]>(`${environment.api}buscar-frequencia`, { params: { turmaId, materiaId, data } })
  }

  salvarFrequencia(body: FrequenciaPayload) {
    return this.http.post<MsgResponse>(`${environment.api}salvar-frequencia`, body)
  }
